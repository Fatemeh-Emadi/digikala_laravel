@include('.../header')
        ...
        <nav class="navbar navbar-expand-lg navbar-light  " style="background-color: white;">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <img src="https://www.digikala.com/static/files/bc60cf05.svg" alt=""
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex">
                        ...
                        <input class="form-control me-2 mt-2" type="search" id="search"
                            ...
                            style="width: 470px; background-color: rgb(233, 233, 233); border: none; font-size: 12px;">
                            <i class="fas fa-search position-absolute mt-3" style="font-size: 15px; left: 720;" ></i> 
        ...
        <nav class="navbar navbar-expand-lg navbar-light  " style="background-color: white;">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item"><img src="images/store_black_24dp.svg" class="img-fluid" width="15px"
                                height="15px"></li>
                        <li class="nav-item">

                            <a class="nav-link active " aria-current="page" href="#"
                                style="font-size: 11px;">سوپرمارکت</a>
                        </li>
                        <li class="nav-item"><img src="images/local_offer_black_24dp.svg" class="img-fluid" width="15px"
                                height="15px"></li>
                        <li class="nav-item">

                            <a class="nav-link " href="#" style="font-size: 11px;">تخفیف ها و پیشنهادها</a>
                        </li>
                        <li class="nav-item"><img src="images/chalet_black_24dp.svg" class="img-fluid" width="18px"
                                height="18px"></li>
                        <li class="nav-item">
                            <a class="nav-link " href="#" style="font-size: 11px;">دیجی کالای من</a>
                        </li>
                        <li class="nav-item"><img src="images/loupe_black_24dp.svg" class="img-fluid" width="15px"
                                height="15px"></li>
                        <li class="nav-item">
                            <a class="nav-link " style="font-size: 11px;">دیجی پلاس</a>
                        </li>
                        <li class="nav-item"><img src="images/auto_awesome_black_24dp.svg" class="img-fluid"
                                width="15px" height="15px"></li>
                        <li class="nav-item">
                            <a class="nav-link " style="font-size: 11px;">دیجی کلاب</a>
                        </li>
                        <li class="nav-item"><img src="images/photo_filter_black_24dp.svg" class="img-fluid"
                                width="15px" height="15px"></li>
                        <li class="nav-item">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide " data-bs-ride="carousel">
                            <div class="carousel-indicators">
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0"
                                    class="active rounded-circle" aria-current="true" aria-label="Slide 1" style="width: 10px; height: 10px;"></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1"
                                  class="rounded-circle"  aria-label="Slide 2" style="width: 10px; height: 10px;"></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2"
                                   class="rounded-circle" aria-label="Slide 3" style="width: 10px; height: 10px;"></button>
                            </div>
                            <div class="carousel-inner" style="border-radius: 12px;">
                                <div class="carousel-item active">
                                    <img src="https://dkstatics-public.digikala.com/digikala-adservice-banners/c0733742b900f9b30e0b719dddd06362a345ce94_1641402963.jpg?x-oss-process=image/quality,q_80"
                                        class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://dkstatics-public.digikala.com/digikala-adservice-banners/8f50be84d7b4c96334e531913fcc25f0efcfad0e_1641396653.jpg?x-oss-process=image/quality,q_80"
                                        class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://dkstatics-public.digikala.com/digikala-adservice-banners/e51dd63ae816581ff0a378b9de00ac29a7c7c1d0_1641647905.jpg?x-oss-process=image/quality,q_80"
                                        class="d-block w-100" alt="...">
                                </div>
                            </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg col-md-6 col-sm-12 mt-1">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">شارژر</h5>
                                    <p class="card-text " style="font-size:12px;">شارژر همراه انکر مدل PowerCore</p>
                                    
                                    <a href="#" class="btn btn-outline-danger">478/000 تومان</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg col-md-6 col-sm-12 mt-1">
                            <div class="card" >
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">ماشین شارژی</h5>
                                    <p class="card-text" style="font-size:12px;">ماشین شارژی مدل QLS8889</p>
                                    <a href="#" class="btn btn-outline-danger">650/000 تومان</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg col-md-6 col-sm-12 mt-1">
                            <div class="card" >
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">گوشی همراه</h5>
                                    <p class="card-text" style="font-size:12px;">گوشی همراه شیائومی  REDEMI</p>
                                    <a href="#" class="btn btn-outline-danger">7/800/000 تومان</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg col-md-6 col-sm-12 mt-1">
                            <div class="card" >
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">چمدان</h5>
                                    <p class="card-text" style="font-size:12px;"> چمدان خلبانی فیرو مدل 707</p>
                                    <a href="#" class="btn btn-outline-danger">850/000 تومان</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg col-md-6 col-sm-12 mt-1">
                            <div class="card" >
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">لوله بازکن</h5>
                                    <p class="card-text" style="font-size: 12px;">لوله باز کن صاف مقدار 1250 گرم</p>
                                    <a href="#" class="btn btn-outline-success">14/600 تومان</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg col-md-6 col-sm-12 mt-1">
                            <div class="card" >
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">شامپو بدن</h5>
                                    <p class="card-text" style="font-size: 12px;">شامپو بدن صحت مدل Guar</p>
                                    <a href="#" class="btn btn-outline-success">11/000 تومان</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg col-md-6 col-sm-12 mt-1">
                        ...
                        <div class="col-lg col-md-6 col-sm-12 mt-1">
                            <div class="card" >
                                <img src="images/f.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">شامپو</h5>
                                    <p class="card-text" style="font-size: 12px;"> شامپو موهای معمولی شبنم</p>
                                    <a href="#" class="btn btn-outline-success">22/000 تومان</a>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-lg-6 col-md-12 col-sm-12 mt-1">
                    <img src="images/10.jpg" class="img-fluid rounded-3 shadow-sm">
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 mt-1">
                    <img src="images/11.jpg" class="img-fluid rounded-3 shadow-sm">
                </div>
            </div>
        </div>
            <div class="container-fluid">
                <div class="row  py-4  mt-3 " >
                    ...
                    <div class="col-10 ">
                        ...
                        <div class="row py-3 shadow-sm" style=" background-color: white; border-radius: 7px;">
                            <h5>اسپیکر (بلندگو)</h5>
                            <p>بر اساس باز دید های شما</p>
                            <div class="col-lg col-md-6 col-sm-12">
                                <div class="card" style="border: none;">
                                    <img src="images/f1.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title">اسپیکر</h5>
                                        <p class="card-text">اسپیکر بلوتوثی قابل حمل تی اند جی مدل TG-113</p>
                                        <a href="#" class="btn btn-outline-danger">115/000 تومان</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg col-md-6 col-sm-12">
                            ...
                            <div class="col-lg d-none d-lg-block  d-xl-block d-xxl-block ">
                                <div class="card" style="border: none; background-color: white;" >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-center">برای مشاهده پیشنهادهای
                                            مناسب خودو همچنین داشتن تجربه بهتر وارد حساب کاربری شوید.</p>
                            ...
                            <div class="col-lg col-md-6 col-sm-12">
                                <div class="card" style="border: none;" >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">پلیور مردانه پاییزان کد P700 رنگ قرمز روشن</p>
                                        <a href="#" class="btn btn-outline-danger">223/000 تومان</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg col-md-6 col-sm-12">
            ...
            <div class="container ">'
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-12  mt-5 shadow-sm" style="background-color: white; border-radius: 5px; ">
                         
                        <div class="row ms-2 mt-2">
                            <h5>سه چرخه موتور و ماشین بازی</h5>
                         <p>براساس بازدید های شما</p>
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card" style="border: none;" >
                                    <img src="images/x.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">

                                        <p class="card-text">ماشین شارژی مدل ZR5262</p>
                                        <a href="#" class="btn btn-outline-secondary">650/000 تومان</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12">
                ...
                <div class="col-12 shadow-sm mt-5"  style="background-color: white; border-radius: 5px; ">
                    ...
                    <div class="row ms-2 mt-2">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="card border-0" >
                                <img src="images/y.jpg" class="card-img-top" alt="...">
                                <div class="card-body">

                                    <p class="card-text">
                                        شارژر همراه لیتو مدل LP-8 </p>
                                    <a href="#" class="btn btn-outline-secondary">795/000 تومان</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
   ...
   <div class="container">
        <div class="row mt-4">
            <div class="col-lg-6 col-md-12 col-sm-12 mt-1">
                <img src="images/16.jpg" class="img-fluid shadow-sm rounded" >
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 mt-1">
                <img src="images/17.jpg" class="img-fluid shadow-sm rounded-3" >
            </div>
        </div>
    </div>
        <div class="container-fluid">

            <div class="col-12 mt-5 shadow-sm rounded-3 " style="background-color: white;">

                <div class="row  ">
                    <h5 class=" ms-3 mt-3">انواع بادی اسپلش</h5>
                    <p class="ms-3">بر اساس بازدید های شما</p>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="card border-0" >
                            <img src="images/x1.jpg" class="card-img-top" alt="...">
                            <div class="card-body">

                                <p class="card-text">
                                    بادی اسپلش مردانه مای مدل Icy Wave حجم 220 میلی لیتر</p>
                                <a href="#" class="btn btn-outline-secondary">72/840 تومان</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
    ...
    <div class="container-fluid">
        ...
        <div class="col-12 mt-4 shadow-sm rounded-3" style="background-color: white;">
            ...
            <div class="row ">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card border-0" >
                        <img src="images/x2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">

                            <p class="card-text">گوشی موبایل شیائومی مدل POCO X3 Pro M2102J20SG دو سیم‌ کارت ظرفیت 256
                                گیگابایت و 8 گیگابایت رم</p>
                            <a href="#" class="btn btn-outline-secondary">6/650/000 تومان</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
    ...
    <div class="container-fluid">
        ...
        <div class="col-12 mt-4 rounded-3 shadow-sm" style="background-color: white;">
            ...
            <div class="row ">
                <h5 class="mt-3 ms-3">انواع شال و روسری</h5>
                <p class="ms-3">براساس بازدید های شما</p>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card border-0" >
                        <img src="images/x3.jpg" class="card-img-top" alt="...">
                        <div class="card-body">

                            <p class="card-text">
                                شال زنانه لئونارد مدل موهر پاییزی کد 0357</p>
                            <a href="#" class="btn btn-outline-secondary">193/000 تومان</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
    ...
    <div class="container-fluid">
        ...
        <div class="col-12 mt-4 rounded-3 shadow-sm" style="background-color: white;">
            ...
            <div class="row ">
                <h5 class="ms-3 mt-3">پروفروش ترین ها</h5>
                <p class="ms-3">پیشنهاد ویژه</p>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card border-0" >
                        <img src="images/x4.jpg" class="card-img-top" alt="...">
                        <div class="card-body">

                            <p class="card-text">گوشی موبایل سامسونگ مدل Galaxy A12 Nacho SM-A127F/DS دو سیم کارت ظرفیت
                                64 گیگابایت و رم 4 گیگابایت</p>
                            <a href="#" class="btn btn-outline-secondary">3/500/000 تومان</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
    ...
    <div class="container-fluid">
        <div class="col-12  mt-4 shadow-sm" style="background-color: white; border-radius: 5px; ">
                         
            <div class="row ms-2 mt-3">
                <h5 class="mt-3">منتخب محصولات تخفیف و حراج</h5>
             
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card" style="border: none;" >
                        <img src="images/k1.jpg" class="card-img-top" alt="...">
                        <div class="card-body">

                            <p class="card-text">کتاب خودت را به فنا نده اثر گری جان </p>
                            <ul class="list-group mt-3 border-0 ">
                                <li class="list-group-item d-flex justify-content-end align-items-center border-0">
                                    <p class="fw-bolder text-decoration-line-through text-secondary me-2 "> 35.000 </p>
                                    <span class="position-relative  badge bg-danger rounded-pill">54%</span>
                                </li>
                            <a href="#" class="btn btn-outline-danger">16/000 تومان</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card" style="border: none;" >
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">ارگانایزر کیف مدل 1036</p>
                            <ul class="list-group mt-3 border-0 ">
                                <li class="list-group-item d-flex justify-content-end align-items-center border-0">
                                    <p class="fw-bolder text-decoration-line-through text-secondary me-2 "> 65.000 </p>
                                    <span class="position-relative  badge bg-danger rounded-pill">58%</span>
                                </li>
                            <a href="#" class="btn btn-outline-danger">30/000 تومان</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card" style="border: none;" >
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">دفتر مشق 50 برگ مدل BS 209</p>
                            <ul class="list-group mt-3 border-0 ">
                                <li class="list-group-item d-flex justify-content-end align-items-center border-0">
                                    <p class="fw-bolder text-decoration-line-through text-secondary me-2 "> 15.000 </p>
                                    <span class="position-relative  badge bg-danger rounded-pill">24%</span>
                                </li>
                            <a href="#" class="btn btn-outline-danger">9/500 تومان</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card" style="border: none;" >
                        ...
                        <div class="card-body">
                            <p class="card-text">دفتر برنامه ریزی 80 برگ پالت</p>
                            <ul class="list-group mt-3 border-0 ">
                                <li class="list-group-item d-flex justify-content-end align-items-center border-0">
                                    <p class="fw-bolder text-decoration-line-through text-secondary me-2 "> 30.000 </p>
                                    <span class="position-relative  badge bg-danger rounded-pill">15%</span>
                                </li>
                            <a href="#" class="btn btn-outline-danger">25/000 تومان</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="row mt-4 ">
                <div class="col-lg col-md col-sm ms-5 d-none d-lg-block  d-xl-block d-xxl-block">
                    <figure class="figure text-center ">
                        <img src="images/box.svg" class="figure-img img-fluid rounded" alt="..." width="35px"
                            height="30px">
                ...
                <div class="col-lg col-md col-sm d-none d-lg-block  d-xl-block d-xxl-block">
                    <figure class="figure text-center ">
                        <img src="images/credit-card-2-front.svg" class="figure-img img-fluid rounded" alt="..."
                ...
                <div class="col-lg col-md col-sm d-none d-lg-block  d-xl-block d-xxl-block">
                    <figure class="figure text-center">
                        <img src="images/headset.svg" class="figure-img img-fluid rounded" alt="..." width="35px"
                            height="30px">
                ...
                <div class="col-lg col-md col-sm d-none d-lg-block  d-xl-block d-xxl-block">
                    <figure class="figure text-center">
                        <img src="images/mailbox.svg " class="figure-img img-fluid rounded" alt="..." width="35px"
                            height="30px">
                ...
                <div class="col-lg col-md col-sm d-none d-lg-block  d-xl-block d-xxl-block">
                    <figure class="figure text-center">
                        <img src="images/bag-check.svg" class="figure-img img-fluid rounded" alt="..." width="35px"
                            height="30px">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg col-md col-sm-12 mt-3">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="gray" class="bi bi-telegram"
                        viewBox="0 0 16 16">
                        <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="gray"
                        class="bi bi-instagram ms-4" viewBox="0 0 16 16">
                        <path
